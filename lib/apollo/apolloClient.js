import { ApolloClient, ApolloLink, HttpLink, InMemoryCache, fromPromise,split } from "@apollo/client";
...
import {WEBSOCKET__URL} from "../../apiConfig";
...
export default function createApolloClient() {
  ...
  const httpLinks = new HttpLink({ uri: graphqlUrl, credentials: "same-origin", fetch });
  ...
  const httpLink  = process.browser ? split( //only create the split in the browser
