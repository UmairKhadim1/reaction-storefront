...
function ProductDetailPage(props) {
  ...
  const { addItemsToCart, product, isLoadingProduct, shop } = props;
  ...
  return (
    <Layout shop={shop}>
      ...
      {variantPage.show? 
       ...
       currentVariantId={variantPage.variantId}
       selectedVariantSize= {variantPage.selectedVariantSize}
       handleProductPage={()=>setVariantPage({show:false,variantId:null,selectedVariantSize:0})}
     />
      :
       <ProductDetail
       pageInfo={catalogItemsPageInfo}
        ...
        shop={shop}
        catalogItems={catalogItems}
        handleVariantPage={(currentVariantId, selectedVariantSize)=>setVariantPage({show:true,variantId:currentVariantId,selectedVariantSize:selectedVariantSize})}
      />}
      <DownloadSection/>
      {/* <ProductDetail
        addItemsToCart={addItemsToCart}
...
export default withApollo()(withCatalogItems(inject("routingStore", "uiStore")( withCart(ProductDetailPage))));
