...
function AcceptOfferConfirmation(props) {
    ...
    return (
        <Dialog className="writeReview__Wrapper" maxWidth="xs" fullWidth={true} onClose={handleClose} aria-labelledby="simple-dialog-title" open={props.open}>
            ...
            <Grid xs={12} sm={12} >
               {props.message=="Accept"? <Typography className="AcceptOffer__title" variant="h6">Are you sure to accept this Game offer?</Typography>:<Typography className="AcceptOffer__title" variant="h6">Are you sure to Reject this Game offer?</Typography>}
                </Grid>
